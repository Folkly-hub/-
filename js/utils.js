...
const Utils = {
  ...
  generatePortrait(hero) {
    ...
    if (hero === 'guanyu') {
    ...
    } else if (hero === 'dongzhuo_vanguard') {
      // Dong Zhuo's Vanguard Commander - Elite dark purple armor
      svgString = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <defs>
          <radialGradient id="bgDZV" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stop-color="#3b1f5e"/>
            <stop offset="100%" stop-color="#12081f"/>
          </radialGradient>
        </defs>
        <circle cx="50" cy="50" r="48" fill="url(#bgDZV)" stroke="#9b59b6" stroke-width="3"/>
        <path d="M 14 90 Q 50 56 86 90 L 92 100 L 8 100 Z" fill="#2c1654" stroke="#9b59b6" stroke-width="2"/>
        <ellipse cx="50" cy="48" rx="20" ry="22" fill="#b8860b"/>
        <path d="M 22 32 Q 50 10 78 32 L 74 18 Q 50 4 26 18 Z" fill="#1a0f2e" stroke="#d4af37" stroke-width="2"/>
        <polygon points="50,2 58,16 42,16" fill="#e74c3c"/>
        <path d="M 16 18 Q 0 4 -6 -14" stroke="#9b59b6" stroke-width="4" fill="none"/>
        <path d="M 84 18 Q 100 4 106 -14" stroke="#9b59b6" stroke-width="4" fill="none"/>
        <path d="M 33 43 L 44 46" stroke="#000" stroke-width="3.5"/>
        <path d="M 67 43 L 56 46" stroke="#000" stroke-width="3.5"/>
        <circle cx="39" cy="48" r="2.5" fill="#e74c3c"/>
        <circle cx="61" cy="48" r="2.5" fill="#e74c3c"/>
    ...
    } else if (hero === 'dongzhuo') {
      // Dong Zhuo - Tyrant in dark imperial robes
      svgString = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <defs>
          <radialGradient id="bgDZ" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stop-color="#2c1810"/>
            <stop offset="100%" stop-color="#0a0604"/>
          </radialGradient>
        </defs>
        <circle cx="50" cy="50" r="48" fill="url(#bgDZ)" stroke="#d4af37" stroke-width="3"/>
        <path d="M 16 90 Q 50 58 84 90 L 90 100 L 10 100 Z" fill="#1a0f0a" stroke="#d4af37" stroke-width="2"/>
        <ellipse cx="50" cy="50" rx="22" ry="24" fill="#c49a6c"/>
        <path d="M 28 52 Q 50 78 72 52 Q 50 68 28 52 Z" fill="#222"/>
        <path d="M 24 30 Q 50 16 76 30 L 72 18 Q 50 8 28 18 Z" fill="#d4af37" stroke="#b38715" stroke-width="2"/>
        <polygon points="50,6 56,18 44,18" fill="#e74c3c"/>
        <path d="M 34 42 L 44 44" stroke="#111" stroke-width="3"/>
        <path d="M 66 42 L 56 44" stroke="#111" stroke-width="3"/>
        <circle cx="40" cy="46" r="2" fill="#000"/>
        <circle cx="60" cy="46" r="2" fill="#000"/>
      </svg>`;
    } else if (hero === 'lubu_silhouette') {
      // Lu Bu Silhouette - mysterious dark shadow, first tease
      svgString = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <defs>
          <radialGradient id="bgSil" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stop-color="#1a1a1a"/>
            <stop offset="100%" stop-color="#000000"/>
          </radialGradient>
        </defs>
        <circle cx="50" cy="50" r="48" fill="url(#bgSil)" stroke="#444" stroke-width="3"/>
        <path d="M 38 20 Q 12 -8 8 -20" stroke="#333" stroke-width="5" fill="none" stroke-linecap="round"/>
        <path d="M 62 20 Q 88 -8 92 -20" stroke="#333" stroke-width="5" fill="none" stroke-linecap="round"/>
        <path d="M 18 90 Q 50 62 82 90 L 88 100 L 12 100 Z" fill="#111"/>
        <ellipse cx="50" cy="48" rx="19" ry="22" fill="#0a0a0a"/>
        <path d="M 28 35 L 50 22 L 72 35 L 50 30 Z" fill="#1a1a1a"/>
        <circle cx="40" cy="48" r="3" fill="#e74c3c" opacity="0.6"/>
        <circle cx="60" cy="48" r="3" fill="#e74c3c" opacity="0.6"/>
      </svg>`;
    } else if (hero === 'messenger') {
      // Messenger - traveling courier
      svgString = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="48" fill="#2c3e2a" stroke="#a9c46c" stroke-width="3"/>
        <path d="M 20 90 Q 50 65 80 90 L 85 100 L 15 100 Z" fill="#4a6741" stroke="#a9c46c" stroke-width="2"/>
        <ellipse cx="50" cy="48" rx="17" ry="20" fill="#e5c09f"/>
        <path d="M 30 38 Q 50 24 70 38 L 65 28 Q 50 18 35 28 Z" fill="#6b8e4e"/>
        <rect x="62" y="55" width="18" height="22" rx="2" fill="#8b6914" stroke="#d4af37" stroke-width="1"/>
      ...
      // System/Narrator - Abstract neutral interface
      svgString = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <defs>
          <radialGradient id="bgSystem" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stop-color="#3498db"/>
            <stop offset="100%" stop-color="#1a5276"/>
          </radialGradient>
        </defs>
        <circle cx="50" cy="50" r="48" fill="url(#bgSystem)" stroke="#ecf0f1" stroke-width="3"/>
        <rect x="30" y="30" width="40" height="40" fill="#ecf0f1" stroke="#bdc3c7" stroke-width="2" rx="5"/>
        <circle cx="50" cy="45" r="8" fill="#3498db"/>
        <rect x="35" y="58" width="30" height="4" fill="#3498db" rx="2"/>
        <rect x="42" y="65" width="16" height="4" fill="#3498db" rx="2"/>
      </svg>`;
    } else if (hero === 'elder') {
      // Village Elder
      svgString = `
